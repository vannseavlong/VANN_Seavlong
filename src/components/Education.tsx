  ...
  const educationData = [
    {
      ...
      period: "2022 - Present",
      description:
        "Focused on Full Stack Development, Software Development, and Web Technologies.",
      achievements: [
        "Year 1: Ethic and Foundamental programming",
        "Year 2: Data Structure and Algorithm",
        "Year 3: Real Practice",
      ],
    ...
    },
    {
      ...
      period: "2021 - 2022",
      description:
        "Start with a general knowledge related to Engineering and Construction.",
      achievements: [
