          ...
          >
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className="flex items-center justify-center w-12 h-12 bg-primary text-white rounded-lg mr-4 group-hover:scale-110 transition-transform duration-300">
